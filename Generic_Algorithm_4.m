function [bounding_box, non_upscaled_bb, processed_binary] = Generic_Algorithm_4 (mediumResizedImage, mediumGrayScale, originalGrayScale, extra_properties)
%% This function implements the regular magic wand assisted separation algorithm
    ...
    binaryMaskBottom = bin_mask(mediumResizedImage, 20, bottomYlist, bottomXlist);
    binaryMaskTop = bin_mask(mediumResizedImage, 120, topYlist, topXlist);
    ...
    elapsed = toc;
    disp(strcat('Algorithm 4 finished in: ', string(elapsed)));
end