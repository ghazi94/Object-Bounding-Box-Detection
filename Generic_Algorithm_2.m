function [bounding_box, non_upscaled_bb, processed_binary] = Generic_Algorithm_2 (mediumResizedImage, mediumGrayScale, originalGrayScale, extra_properties)
%% This function implements the regular magic wand assisted separation algorithm
    ...
    binaryMaskTop = bin_mask(mediumResizedImage, 60, topYlist, topXlist);
    ...
    elapsed = toc;
    disp(strcat('Algorithm 2 finished in: ', string(elapsed)));
end