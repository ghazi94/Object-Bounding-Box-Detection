function [bounding_box, non_upscaled_bb, processed_binary] = Generic_Algorithm_1 (mediumResizedImage, mediumGrayScale, originalGrayScale, extra_properties)
%% This function implements the regular magic wand assisted separation algorithm
    tic;
    edgeProximityTolerance = 40;
    ...
    binaryMaskBottom = bin_mask(mediumResizedImage, edgeProximityTolerance, bottomYlist, bottomXlist);
    binaryMaskTop = bin_mask(mediumResizedImage, edgeProximityTolerance, topYlist, topXlist);
    ...
    thresholds = [regionPropAreaThreshold, edgeVerticalProximity, edgeHorizontalProximity, 999];
    ...
    elapsed = toc;
    disp(strcat('Algorithm 1 finished in: ', string(elapsed)));
end